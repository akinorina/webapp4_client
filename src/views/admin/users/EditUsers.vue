...
<template>
  ...
  <ModalGeneral ref="modalUpdateConfirm" :class-bg="'bg-slate-200'" :class-fg="'bg-white text-black'">
  ...
  <ModalGeneral ref="modalUpdateSuccess" :class-bg="'bg-slate-200'" :class-fg="'bg-white text-black'">
    <div class="h-54 w-80 rounded-lg border p-3">
      <div class="mb-3 text-center">
        <div class="font-bold">ユーザー情報</div>
  ...
  <ModalGeneral ref="modalDeleteConfirm" :class-bg="'bg-slate-200'" :class-fg="'bg-white text-black'">
    <div class="h-54 w-80 rounded-lg border p-3">
      <div class="mb-3 text-center">
        <div class="font-bold">ユーザー情報</div>
  ...
  <ModalGeneral ref="modalDeleteSuccess" :class-bg="'bg-slate-200'" :class-fg="'bg-white text-black'">
    <div class="h-54 w-80 rounded-lg border p-3">
      <div class="mb-3 text-center">
        <div class="font-bold">ユーザー情報</div>
